...
public class StageAcademyMovement : Academy
{
    #region Variables:
    // ------------------------------------------------------
    ...
    public Transform aggressiveSpawnLocation;
    public Transform passiveSpawnLocation;
    ...
    private void GeneratePlayers()
    {
        ...
        {
            // Get random Vector2 value
            Vector2 position = new Vector2(aggressiveSpawnLocation.position.x, aggressiveSpawnLocation.position.y);
        ...
        {
            // Get random Vector2 value
            Vector2 position = new Vector2(passiveSpawnLocation.position.x, passiveSpawnLocation.position.y);
